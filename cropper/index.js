  ...
  onPageScroll: function (e) {
    ...
    methods: {
        ...
        normalCropper(){
          ...
          // var toheight = Math.trunc(344 * this.data.cropperInitH / this.data.cropperInitW);        //根据图片比例换算出图片高度

          // ctx.drawImage(imageSrc, 0, 0, this.data.cropperInitW, this.data.cropperInitH, 0, 0, towidth, toheight);
          ctx.drawImage(imageSrc, 0, 0,IMG_REAL_W, IMG_REAL_H);
          ctx.setFontSize(18)
          ctx.setFillStyle('#ffffff')
          var str = "妆啥" + '@' + app.globalData.userInfo.nickName;
          ctx.fillText(str, (this.data.qualityWidth - ctx.measureText(str).width) / 2+180, this.data.qualityWidth/ this.data.innerAspectRadio-30)
            ctx.draw(true, () => {
