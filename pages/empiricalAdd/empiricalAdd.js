...
Page({
  ...
  onLoad: function(options) {
    ...
    //获取用户轨迹
    getApp().getUserTrajectory(5, 'onLoad', 'pages/empiricalAdd_0', '进入经验发布页面');//获取用户轨迹
  ...
  formSubmit: function(e) {
    ...
    if (e.detail.value.textarea.length == 0) {
      ...
      return false
    } else if (e.detail.value.textarea.length < 300) {
      wx.showToast({
        title: `内容须在300字以上`,
        image: '/images/Tips.png',
        duration: 2000
  ...
  onShareAppMessage: function (res) {
    return {
      title: '',
      path: '/pages/empiricalAdd/empiricalAdd',
      success: function (res) {
        // 转发成功
      },
      fail: function (res) {
